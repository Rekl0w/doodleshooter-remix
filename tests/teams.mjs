...
async function eliminate(host,ids,killer){await host.evaluate(({ids,killer})=>{for(const id of ids){const p=__game.combat.players.get(id);p.protectedUntil=0;__game.combat.damage(p,110,killer,{src:'sniper'});}}, {ids,killer});}
try{
